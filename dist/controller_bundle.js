...
var _JoinPlayer = __webpack_require__(31);

var _JoinPlayer2 = _interopRequireDefault(_JoinPlayer);
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(_JoinPlayer2.default, null);
		}
	}]);
...
var JoinPlayer = function (_Component) {
	_inherits(JoinPlayer, _Component);

	function JoinPlayer(props) {
		_classCallCheck(this, JoinPlayer);

		var _this = _possibleConstructorReturn(this, (JoinPlayer.__proto__ || Object.getPrototypeOf(JoinPlayer)).call(this, props));
	...
	_createClass(JoinPlayer, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'join-player' },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_ColorPicker2.default, { className: 'input',
		...
		value: function handleColorChange(value) {
			this.setState({
				inputColor: value
			});
		}
...
var _ColorSwatch = __webpack_require__(33);
...
var ColorPicker = function (_Component) {
	...
	_createClass(ColorPicker, [{
		...
		value: function render() {
			...
			var className = CLASS_NAME + (this.props.className ? ' ' + this.props.className : '');
			return _react2.default.createElement(
				'div',
				{ className: className },
				' ',
				this.props.colors.map(function (c) {
					return _react2.default.createElement(_ColorSwatch2.default, {
						color: c,
						selected: _this2.props.selectedColor == c,
...
ColorPicker.defaultProps = {
	selectedColor: null,
	colors: ['#b80000', '#db3e00', '#fccb00', '#008b02', '#006b76', '#1273de', '#004dcf', '#5300eb', '#9900ef', '#eb144c']
};
...
var CLASS_NAME = 'swatch';
var SELECTED_CLASS_NAME = 'selected';

var ColorSwatch = exports.ColorSwatch = function ColorSwatch(_ref) {
    ...
    var svgClass = selected ? SELECTED_CLASS_NAME : '';

    return _react2.default.createElement(
        'div',
        { onClick: handleClick, style: { backgroundColor: color }, className: className },
        _react2.default.createElement(
            'svg',
            { viewBox: '0 0 24 24', className: svgClass },
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/less-loader/dist/cjs.js!./color.less", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/less-loader/dist/cjs.js!./color.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/cjs.js!./joinplayer.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/less-loader/dist/cjs.js!./joinplayer.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".join-player > div {\n  display: flex;\n  margin-top: 20px;\n  position: relative;\n}\n.join-player label {\n  flex: 1;\n  display: inline-block;\n  text-align: right;\n  padding-right: 20px;\n}\n.join-player input {\n  height: 50px;\n  font-size: 30px;\n  padding-left: 6px;\n}\n.join-player input,\n.join-player .input {\n  flex: 1;\n}\n.join-player button {\n  width: calc(50% - 10px);\n  position: absolute;\n  right: 0;\n  height: 50px;\n  font-size: 30px;\n}\n", ""]);
